...
export class ConfirmAttendeesCall extends ethereum.Call {
  get inputs(): ConfirmAttendeesCall__Inputs {
    return new ConfirmAttendeesCall__Inputs(this);
  }

  get outputs(): ConfirmAttendeesCall__Outputs {
    return new ConfirmAttendeesCall__Outputs(this);
  }
}

export class ConfirmAttendeesCall__Inputs {
  _call: ConfirmAttendeesCall;

  constructor(call: ConfirmAttendeesCall) {
    this._call = call;
  }
...
export class ConfirmAttendeesCall__Outputs {
  _call: ConfirmAttendeesCall;
...
export class RsvpToEventCall extends ethereum.Call {
  get inputs(): RsvpToEventCall__Inputs {
    return new RsvpToEventCall__Inputs(this);
  }

  get outputs(): RsvpToEventCall__Outputs {
    return new RsvpToEventCall__Outputs(this);
  }
}

export class RsvpToEventCall__Inputs {
  _call: RsvpToEventCall;

  constructor(call: RsvpToEventCall) {
    this._call = call;
  }
...
export class RsvpToEventCall__Outputs {
  _call: RsvpToEventCall;
